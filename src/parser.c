...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [30] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2),
  [32] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(4),
  [35] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(4),
  ...
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__any, 1),
  [54] = {.entry = {.count = 1, .reusable = false}}, SHIFT(21),
  [56] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__any, 1),
  [58] = {.entry = {.count = 1, .reusable = false}}, SHIFT(15),
  [60] = {.entry = {.count = 1, .reusable = false}}, SHIFT(13),
  [62] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__any_comment, 1),
  [66] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__any_comment, 1),
  [68] = {.entry = {.count = 1, .reusable = true}}, SHIFT(12),
  [70] = {.entry = {.count = 1, .reusable = false}}, SHIFT(12),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__any_comment_repeat1, 2),
  [74] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__any_comment_repeat1, 2), SHIFT_REPEAT(21),
  [77] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__any_comment_repeat1, 2),
  [79] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__any_comment_repeat1, 2), SHIFT_REPEAT(12),
  [82] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__any_comment_repeat1, 2), SHIFT_REPEAT(12),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_loop, 2),
  [87] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_loop, 2),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__any, 2),
  [91] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__any, 2),
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_loop, 3),
  [95] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_loop, 3),
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment_loop, 3),
  [99] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment_loop, 3),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment_loop, 2),
  [103] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment_loop, 2),
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_initial_comment, 1),
  [107] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_initial_comment, 1),
  ...
  [119] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_comment_loop_repeat1, 2), SHIFT_REPEAT(25),
  [122] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_comment_loop_repeat1, 2), SHIFT_REPEAT(23),
  [125] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_comment_loop_repeat1, 2),
